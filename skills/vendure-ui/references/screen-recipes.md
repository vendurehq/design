...
Find, filter, inspect, and act on a collection of domain records.
...
```tsx
import { Page, PageLayout, PageTitle } from '@vendure/dashboard';
...
Understand one entity, edit its fields, and perform consequential actions.
...
Guide a user through entering and validating a new domain object.
...
Orient the user with a small number of high-value metrics and next actions.
...
Organize durable configuration into understandable sections with safe save behavior.
