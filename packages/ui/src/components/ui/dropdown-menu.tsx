...
function DropdownMenuContent({
  ...
  return (
    <MenuPrimitive.Portal>
      ...
      >
        {/* [vendure] removed w-(--anchor-width): it pinned the popup width to the trigger width, making wide items wrap; the popup should size to its content (min-w-32 keeps the floor) */}
        <MenuPrimitive.Popup
