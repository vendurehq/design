...
// Plain <input> rather than Base UI's Input (which wraps Field.Control): the
// Field-managed value/dirty state conflicts with react-hook-form's isDirty
// detection. A null value is coerced to "" so a form field that starts null
// stays controlled instead of flipping between controlled and uncontrolled.
function Input({
  className,
  type,
  value,
